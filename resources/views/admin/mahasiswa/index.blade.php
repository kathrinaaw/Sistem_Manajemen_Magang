    ...
    <div class="row align-items-center mb-4">
        <div class="col">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h1 class="fw-bold text-dark mb-1">Data Mahasiswa</h1>
    ...
    <div class="card border-0 shadow-lg">
        ...
        <div class="card-body p-0">
                ...
                <table class="table table-hover mb-0">
                    <thead style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                        <tr>
                            <th class="text-white fw-semibold py-3 px-4">
                                <i class="fas fa-id-badge me-2"></i>NPM
                            </th>
                            <th class="text-white fw-semibold py-3 px-4">
                            ...
                            <th class="text-white fw-semibold py-3 px-4">
                                <i class="fas fa-phone me-2"></i>No. Telp
                            </th>
                            <th class="text-white fw-semibold py-3 px-4">
                    ...
                    <tbody>
                        ...
                        <tr class="table-row-hover">
                            <td class="py-3 px-4">
                                <span class="fw-semibold text-primary">{{ $mhs->npm_mhs }}</span>
                            </td>
                            <td class="py-3 px-4">
                                <span class="fw-semibold">{{ $mhs->nama_mhs }}</span>
                            </td>
                            <td class="py-3 px-4">
                                <span class="badge bg-light text-dark px-3 py-2">{{ $mhs->prodi }}</span>
                            </td>
                            <td class="py-3 px-4 text-muted">{{ $mhs->alamat }}</td>
                            <td class="py-3 px-4">
                                <span class="text-success fw-semibold">{{ $mhs->no_telp }}</span>
                            </td>
                            <td class="py-3 px-4">
                                <a href="mailto:{{ $mhs->email }}" class="text-decoration-none" style="color: #667eea;">
                                    {{ $mhs->email }}
                                </a>
                            </td>
                            <td class="py-3 px-4 text-center">
                                <div class="btn-group" role="group">
                                    <a href="{{ route('admin.mahasiswa.edit', $mhs->npm_mhs) }}" 
                                       class="btn btn-sm btn-outline-primary px-3"
                                       data-bs-toggle="tooltip" 
                                       title="Edit Data">
                                        Edit
                                    </a>
                                    <form action="{{ route('admin.mahasiswa.destroy', $mhs->npm_mhs) }}" 
                                          method="POST" 
                                          class="d-inline"
                                          onsubmit="return confirm('Yakin ingin menghapus data {{ $mhs->nama_mhs }}?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
            ...
            <div class="text-center py-5">
                ...
                <h4 class="text-muted mb-2">Belum Ada Data Mahasiswa</h4>
                <p class="text-muted mb-4">Silakan tambah data mahasiswa untuk memulai</p>
                <a href="{{ route('admin.mahasiswa.create') }}" 
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h5 class="fw-bold">{{ count($mahasiswa) }}</h5>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">  
                    ...
                    <h5 class="fw-bold">{{ collect($mahasiswa)->unique('prodi')->count() }}</h5>
