...
class MagangController extends Controller
{
    ...
    public function create()
    {
        try {
            ...
            return view('admin.magang.create', compact('mahasiswa', 'perusahaan', 'pembimbing'));
    ...
    public function edit($id)
    {
        try {
            ...
            if ($response->successful()) {
                ...
                return view('admin.magang.edit', compact('magang', 'mahasiswa', 'perusahaan', 'pembimbing'));
            } else {
                return redirect()->route('admin.magang.index')->with('error', 'Data magang tidak ditemukan');
            }
        } catch (\Exception $e) {
            return redirect()->route('admin.magang.index')->with('error', 'Tidak dapat terhubung ke server: ' . $e->getMessage());
        }
    }
